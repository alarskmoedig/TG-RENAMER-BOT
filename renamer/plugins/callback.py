...
from pyrogram import Client as alarskmoedig, filters
...
@alarskmoedig.on_callback_query(filters.regex('^help$'))
...
@alarskmoedig.on_callback_query(filters.regex('^donate$'))
...
@alarskmoedig.on_callback_query(filters.regex('^close$'))
...
@alarskmoedig.on_callback_query(filters.regex('^back$'))
...
@alarskmoedig.on_callback_query(filters.regex('^about$'))
